...
using StartAndFinish_Func = std::string (*)();
using WordParser_Func = std::string (*)(std::string &);
using DigitParser_Func = std::string (*)(int);
...
public:
    TokenParser(const StartAndFinish_Func &StartCallback = Start_default, const StartAndFinish_Func &FinishCallback = Finish_default,
        const WordParser_Func &WordParser = WordParser_default, const DigitParser_Func &DigitParser = DigitParser_default);
